...
# pytest unit_testing/basics.py 
# ========================================================================================= test session starts ==========================================================================================
# platform darwin -- Python 3.10.1, pytest-7.4.2, pluggy-1.3.0
# rootdir: /Users/tati/Documents/Git Repos/useful_samples
# collected 1 item                                                                                                                                                                                       
# 
# unit_testing/basics.py .                                                                                                                                                                         [100%]
# 
# ========================================================================================== 1 passed in 0.13s ===========================================================================================
...
# 5. Стоит избегать больших секций Assert. Пример: имеем проверки на равенство для большого количества полей возвращаемого объекта.
# Решение: Добавить в тестовый класс дополнительный метод для сравнения таких полей.
# 6. Договоритесь о правилах именования переменных/данных в тестах.
...
def test_sample():
    ...
    # В целом если необходимо подменять класс и потом работать с его экземпляром и его атрибутами, то лучше делать patch.
